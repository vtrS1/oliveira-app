...
class SignatureTestemunhaView extends StatefulWidget {
  SignatureTestemunhaView({Key? key}) : super(key: key);

  @override
  _SignatureTestemunhaViewState createState() =>
      _SignatureTestemunhaViewState();
}

class _SignatureTestemunhaViewState extends State<SignatureTestemunhaView> {
  ...
  Future<File> get _localFile async {
    ...
    print(path);
    return File('$path/ASSINATURA-VENDEDOR-TESTEMUNHA.png');
  }
  ...
  Future uploadSignature(String path) async {
    ...
    form['cpf'] = box.read('cpf') + '-testemunha';
    ...
    try {
      ...
      if (res.data['status']) {
        ...
        await connection.postSimple(
            Constants.API_HOST +
                'external/vendedor/imagem/assinatura-testemunha',
            form);
        ...
        Get.snackbar('Aviso',
            'Ocorreu um erro no envio da assinatura da testemunha, tente novamente...');
        return null;
      }
    } catch (e, stackTrace) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Assinatura da testemunha',
              ...
              onPressed: () async {
                try {
                  ...
                  if (png != null) {
                    ...
                    await box.write(
                        'assinaturaVendedorTestemunha', signature.path);
